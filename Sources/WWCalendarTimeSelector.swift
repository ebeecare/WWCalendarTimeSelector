    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if showingHour {
            let textAttr : [NSAttributedStringKey : Any] = [
                .font: fontHour,
                .foregroundColor: fontColorHour,
                .paragraphStyle: paragraph
            ]
            let textAttrHighlight : [NSAttributedStringKey : Any] = [
                .font: fontHourHighlight,
                .foregroundColor: fontColorHourHighlight,
                .paragraphStyle: paragraph
            ]
            ...
            let textAttr : [NSAttributedStringKey : Any] = [
                .font: fontMinute,
                .foregroundColor: fontColorMinute,
                .paragraphStyle: paragraph
            ]
            let textAttrHighlight  : [NSAttributedStringKey : Any] = [
                .font: fontMinuteHighlight,
                .foregroundColor: fontColorMinuteHighlight,
                .paragraphStyle: paragraph
            ]
